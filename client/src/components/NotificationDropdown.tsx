                    ...
                    <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                        ...
                        {unreadCount > 0 && (
                            <button
                                ...
                                className="text-sm text-dbi-primary hover:text-dbi-primary/80 flex items-center space-x-1 focus:outline-none focus-visible:ring-2 focus-visible:ring-dbi-primary rounded"
                    ...
                    <div className="max-h-96 overflow-y-auto">
                        ...
                        {unassignedCount > 0 && (
                            <button
                                ...
                                className="w-full text-left px-4 py-3 border-b border-gray-100 dark:border-gray-700 bg-orange-50 dark:bg-orange-900/20 hover:bg-orange-100 dark:hover:bg-orange-900/30 transition-colors cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-orange-500"
                                        ...
                                        <div className="flex items-center space-x-1">
                                            {!notification.isRead && (
                                                <button
                                                    ...
                                                    className="p-1 text-gray-400 hover:text-green-600 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500 rounded"
                                                    title="Mark as read"
                                            ...
                                            <button
                                                ...
                                                className="p-1 text-gray-400 hover:text-red-600 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-red-500 rounded"
                                                title="Delete"
