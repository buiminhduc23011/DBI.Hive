                ...
                >
                    ...
                    <div className="max-h-96 overflow-y-auto">
                        ...
                        {notifications.length === 0 ? (
                            <div className="p-8 text-center text-gray-500 dark:text-gray-400" role="none">
                    ...
                    {notifications.length > 0 && (
                        <div className="px-4 py-3 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700">
                            <button role="menuitem" className="w-full text-center text-sm text-dbi-primary hover:text-dbi-primary/80">
