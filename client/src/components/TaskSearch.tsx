        ...
        <div ref={containerRef} className="relative" data-onboarding="search-task">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    role="combobox"
                    className={`w-full md:w-64 pl-10 py-2 bg-gray-100 dark:bg-gray-700 border border-transparent focus:border-dbi-primary focus:bg-white dark:focus:bg-gray-600 rounded-lg text-sm dark:text-white transition-colors ${!searchText ? 'pr-16' : 'pr-8'}`}
                />
                {!searchText ? (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
                        <kbd className="hidden md:inline-block px-1.5 py-0.5 text-xs font-sans text-gray-400 bg-gray-200 dark:bg-gray-600 rounded border border-gray-300 dark:border-gray-500">
                            {shortcutModifier} K
                        </kbd>
                    </div>
                ) : (
