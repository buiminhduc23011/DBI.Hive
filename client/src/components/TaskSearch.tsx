    ...
    return (
        <div ref={containerRef} className="relative" data-onboarding="search-task">
            ...
            <div className="relative">
                ...
                />
                {!searchText && (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center space-x-1 text-xs text-gray-400 dark:text-gray-500 pointer-events-none select-none">
                        <kbd className="px-1.5 py-0.5 rounded-md border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 font-sans shadow-sm">
                            {isMac ? '⌘' : 'Ctrl'}
                        </kbd>
                        <kbd className="px-1.5 py-0.5 rounded-md border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 font-sans shadow-sm">
                            K
