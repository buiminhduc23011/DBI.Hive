    ...
    return (
        <div ref={containerRef} className="relative" data-onboarding="search-task">
            ...
            <div className="relative">
                ...
                {!searchText && osShortcut && (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none">
                        <kbd className="hidden sm:inline-block px-1.5 py-0.5 text-[10px] font-semibold text-gray-500 bg-gray-200 border border-gray-300 rounded dark:bg-gray-600 dark:text-gray-300 dark:border-gray-500">
                            {osShortcut}
                        </kbd>
                    </div>
                )}
