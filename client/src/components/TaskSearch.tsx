        ...
        <div ref={containerRef} className="relative" data-onboarding="search-task">
            ...
            <div className="relative">
                ...
                <input
                    ...
                    role="combobox"
                    className="w-full md:w-64 pl-10 md:pr-14 pr-8 py-2 bg-gray-100 dark:bg-gray-700 border border-transparent focus:border-dbi-primary focus:bg-white dark:focus:bg-gray-600 rounded-lg text-sm dark:text-white transition-colors"
                />
                {!isOpen && !searchText && (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none hidden md:flex items-center space-x-1 opacity-50">
                        <kbd className="px-1.5 py-0.5 text-[10px] font-sans bg-gray-200 dark:bg-gray-600 text-gray-500 dark:text-gray-400 border border-gray-300 dark:border-gray-500 rounded">
                            {isMac ? '⌘' : 'Ctrl'}
                        </kbd>
                        <kbd className="px-1.5 py-0.5 text-[10px] font-sans bg-gray-200 dark:bg-gray-600 text-gray-500 dark:text-gray-400 border border-gray-300 dark:border-gray-500 rounded">K</kbd>
                    </div>
                )}
                {searchText && (
                    <button
