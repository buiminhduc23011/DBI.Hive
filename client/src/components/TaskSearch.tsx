            ...
            <div className="relative">
                ...
                {!searchText && (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center pointer-events-none">
                        <kbd className="hidden md:inline-block px-1.5 py-0.5 text-[10px] font-medium text-gray-500 dark:text-gray-400 bg-gray-200 dark:bg-gray-600 rounded border border-gray-300 dark:border-gray-500">
                            {modifierKey} K
                        </kbd>
                    </div>
                )}
