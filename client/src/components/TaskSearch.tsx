    ...
    useEffect(() => {
        const detectOS = () => {
            if (typeof navigator !== 'undefined') {
                ...
                setShortcutHint(isMac ? 'Cmd' : 'Ctrl');
            }
        };
        detectOS();
    }, []);
    ...
    return (
        <div ref={containerRef} className="relative" data-onboarding="search-task">
            ...
            <div className="relative">
                ...
                />
                {!searchText && (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none flex items-center hidden md:flex">
                        <kbd className="font-sans font-semibold text-[10px] text-gray-400 border border-gray-300 dark:border-gray-600 rounded px-1.5 py-0.5 bg-gray-50 dark:bg-gray-800">
                            {shortcutHint} K
                        </kbd>
                    </div>
                )}
