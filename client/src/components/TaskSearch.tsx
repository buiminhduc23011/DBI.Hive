            ...
            <div className="relative">
                ...
                {!searchText && (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none hidden md:flex items-center space-x-1">
                        <kbd className="px-1.5 py-0.5 text-[10px] font-sans font-medium text-gray-400 dark:text-gray-500 bg-gray-200 dark:bg-gray-600 rounded border border-gray-300 dark:border-gray-500">
                            {shortcutText.split(' ')[0]}
                        </kbd>
                        <kbd className="px-1.5 py-0.5 text-[10px] font-sans font-medium text-gray-400 dark:text-gray-500 bg-gray-200 dark:bg-gray-600 rounded border border-gray-300 dark:border-gray-500">
                            K
                        </kbd>
