            ...
            <div className="relative">
                ...
                {!searchText && (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none hidden md:flex items-center space-x-1 opacity-50">
                        <kbd className="font-sans text-xs border border-gray-300 dark:border-gray-500 rounded px-1.5 py-0.5 text-gray-500 dark:text-gray-400">{modifierKey}</kbd>
                        <kbd className="font-sans text-xs border border-gray-300 dark:border-gray-500 rounded px-1.5 py-0.5 text-gray-500 dark:text-gray-400">K</kbd>
                    </div>
                )}
                {searchText && (
                    <button
