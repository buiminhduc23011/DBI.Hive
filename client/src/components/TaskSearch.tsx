    ...
    return (
        <div ref={containerRef} className="relative" data-onboarding="search-task">
            ...
            <div className="relative">
                ...
                />
                {!searchText && (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 hidden md:flex items-center space-x-1 pointer-events-none text-gray-400">
                        <kbd className="px-1.5 py-0.5 text-[10px] font-sans font-semibold bg-gray-200 dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-md">
                            {modifierKey}
                        </kbd>
                        <kbd className="px-1.5 py-0.5 text-[10px] font-sans font-semibold bg-gray-200 dark:bg-gray-600 border border-gray-300 dark:border-gray-500 rounded-md">
                            K
