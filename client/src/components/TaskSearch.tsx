            ...
            <div className="relative">
                ...
                {!searchText && !isOpen && (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none text-gray-400">
                        <kbd className="hidden sm:inline-block px-1.5 py-0.5 text-[10px] font-sans font-medium bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded text-gray-500 dark:text-gray-400 shadow-sm">
                            {shortcutHint}
                        </kbd>
                    </div>
                )}
