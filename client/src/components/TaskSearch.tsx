    ...
    return (
        <div ref={containerRef} className="relative" data-onboarding="search-task">
            ...
            <div className="relative">
                ...
                />
                {!searchText && (
                    <div className="absolute right-3 top-1/2 -translate-y-1/2 pointer-events-none flex items-center space-x-1 opacity-50 hidden md:flex">
                        <kbd className="font-sans px-1.5 py-0.5 text-[10px] rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400">{modifierKey}</kbd>
                        <kbd className="font-sans px-1.5 py-0.5 text-[10px] rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400">K</kbd>
                    </div>
                )}
                {searchText && (
                    <button
